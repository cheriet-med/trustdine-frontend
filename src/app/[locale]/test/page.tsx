...
const TrustSystem: React.FC = () => {
  return (
    <div >
      ...
      <h1 className="text-4xl font-extrabold text-white sm:text-5xl mb-6 font-playfair">
        ...
        <p className='my-8 text-white  lg:text-xl font-playfair font-meduim w-max-5xl'>
  At TrustDine, we don't just collect reviews — we verify them.
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {/* Verification Badge */}
        <div className="bg-white rounded-xl shadow-sm p-8 mb-4 border border-a">
...
<div className="bg-white rounded-xl shadow-sm p-8 mb-16 border border-a">
        {/* Mission Statement */}
