...
import WishlistPartnerDashboard from "@/components/partner-dashboard/wishlist";
...
export default function ProtectedPage() {
  ...
  return session?.user?.is_superuser? <DashboardAdmin/> :  ( session?.user?.is_staff? <WishlistPartnerDashboard/>:<MessagesUser/>)
}