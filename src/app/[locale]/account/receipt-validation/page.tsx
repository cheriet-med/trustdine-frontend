...
import ReceiptUser from "@/components/user-dashboard/receiptPage";
...
export default function ProtectedPage() {
  ...
  return session?.user?.is_superuser? <DashboardAdmin/> :  ( session?.user?.is_staff? <DashboardPartner/>:<ReceiptUser/>)
}