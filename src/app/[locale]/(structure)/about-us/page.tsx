...
const Timeline: React.FC<TimelineProps> = ({ items }) => {
  return (
    ...
    <div className="max-w-7xl mx-auto bg-white p-6 lg:p-10 rounded-xl shadow-sm mb-10  font-montserrat">
...
// Example usage with the data from your original HTML
const ExampleTimeline: React.FC = () => {
  const timelineItems: TimelineItem[] = [
    ...
    {
      period: "2021 - 2023",
      title: "Senior Software Engineer at Mailchimp",
      description:
    ...
    {
      period: "2011 - 2021",
      title: "Junior Software Engineer at Slack",
      description:
