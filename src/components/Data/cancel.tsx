...
const menuItems: MenuItem[] = [
  ...
  <div className=' hover:bg-background p-1 rounded-lg' onClick={() => signOut({ callbackUrl: `/en/login` })}>
    ...
    `}>
     ...
     <FcCancel size={32}/>  
      <h1 className="text-2xl font-bold text-gray-500 font-playfair mb-4">Subscription Canceled</h1>
          </div>
  <div className='flex gap-2 flex-wrap'>
      <p className="text-gray-600 ">
        Looks like your subscription wasn’t completed. You can try again whenever you’re ready.
      </p>
      ...
      <RiArrowGoBackFill className='text-secondary'/>
      </div>
