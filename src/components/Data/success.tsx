...
export default function Success() {
  // ALL HOOKS MUST BE CALLED AT THE TOP - NO CONDITIONS BEFORE THEM
  ...
  return (
    ...
    `}>
     ...
     <GrValidate size={32} className='text-green-700'/>  
      <h1 className="text-2xl font-bold text-green-700 font-playfair mb-4">Subscription Successful!</h1>
          </div>
  <div className='flex gap-2 flex-wrap'>
      ...
      <RiArrowGoBackFill className='text-accent'/>
      </div>
