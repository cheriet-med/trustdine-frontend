      ...
      <div className=" px-4">
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="bg-highlights px-8 py-6">
            <h1 className="text-3xl font-bold text-white font-playfair ">Add New Listing</h1>
...
<div className="flex gap-2 mt-6">
                  <div className='w-full'>
                    <label className="block text-sm font-semibold text-gray-500 mb-2">Price per Night *</label>
