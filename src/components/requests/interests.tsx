...
const Interests: React.FC<AmenitiesSelectorProps> = ({ initialAmenities, user }) => {
    ...
    <div className='flex flex-col justify-between '>
      ...
      <div className='flex justify-between items-center gap-4 flex-wrap'>
        ...
        <button
          ...
          className="flex items-center gap-2 px-3 py-1 h-8 w-44 text-sm border-secondary rounded-3xl hover:bg-gray-50 border border-1 transition-colors"
        >
          <FaHandsAslInterpreting size={24} className='text-gray-400'/>
          Add Interests
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl p-6 max-w-2xl w-full mx-4 max-h-[80vh] overflow-y-auto">
            ...
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-xl font-bold font-playfair">Select Interests</h2>
              <button
      ...
      {userAmenities.length === 0 ? (
        <div className="flex items-center justify-center h-24">
          <p className=" text-3xl text-gray-300 uppercase font-playfair font-extrabold">add Interests</p> 
        </div>
      ) : (
