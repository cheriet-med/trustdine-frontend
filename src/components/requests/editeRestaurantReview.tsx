...
<hr className='my-6'/>
                    ...
                    <div className=" my-2 ">
                    <div className='mb-3 flex gap-1 flex-wrap'>
                      <p className="block text-sm font-semibold text-gray-500">Restaurant space *  </p>
                    <p className='text-gray-500 text-sm'>What’s your rating for the restaurant’s space, comfort, and attractiveness?</p>
                    </div>
