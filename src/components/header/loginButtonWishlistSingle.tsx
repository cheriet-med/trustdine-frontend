...
const LoginButtonWishlistSinglepage: React.FC = () => {
...
const handleFacebookleLogin = () => {
 ...
 <button onClick={() => setIsOpen(true)} className='border border-1 border-black px-4 py-1 rounded-3xl flex gap-2 items-center' >
...
export default LoginButtonWishlistSinglepage;