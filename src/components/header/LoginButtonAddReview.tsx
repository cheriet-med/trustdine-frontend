...
const LoginButtonAddReview: React.FC = () => {
...
const handleFacebookleLogin = () => {
 ...
 <div className='flex items-center hover:underline cursor-pointer' onClick={() => setIsOpen(true)}>
...
export default LoginButtonAddReview;