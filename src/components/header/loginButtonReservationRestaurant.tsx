...
const LoginButtonReservationsRestaurant: React.FC = () => {
  ...
  return (
    <>
      {/* Button to open the dialog */}
                    ...
                    <button 
                  className="w-full bg-secondary hover:bg-accent text-white font-medium py-3 rounded-3xl disabled:bg-gray-400"onClick={() => setIsOpen(true)}
                >
                  Make Reservation
                </button>
...
export default LoginButtonReservationsRestaurant;