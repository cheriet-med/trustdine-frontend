...
const LoginButtonSendMessages: React.FC = () => {
  ...
  return (
    <>
      {/* Button to open the dialog */}
         ...
         <div className="border border-1 px-5 py-2 w-48 rounded-3xl border-gray-500 shadow-sm text-sm flex gap-3 mt-4 justify-center cursor-pointer hover:bg-gray-50" onClick={() => setIsOpen(true)}>
...
export default LoginButtonSendMessages;